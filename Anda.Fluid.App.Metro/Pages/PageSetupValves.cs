...
{
    public partial class PageSetupValves : MetroSetUserControl, IMsgSender, IAccessControllable
    {
        ...
        #region 权限
        public int Key { get; set; } = (int)ContainerKeys.PageSetupValves;
        ...
        public void SetDefaultAccess()
        {
            ...
            this.DefaultContainerAccess.ContainerAccessDescription = "阀组设置";
