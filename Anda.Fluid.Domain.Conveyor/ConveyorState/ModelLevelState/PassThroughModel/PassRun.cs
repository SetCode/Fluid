...
namespace Anda.Fluid.Domain.Conveyor.ConveyorState.ModelLevelState.PassThroughModel
{
    public class PassRun : IntegralState
    {
        private SubSiteStateMachine subSiteStateMachine;
        public PassRun(IntegralStateMachine integralStateMachine) : base(integralStateMachine)
        {
        ...
        public override string GetName
        {
            get
            {
                return IntegralStateEnum.运行PassThrough.ToString();
            }
        }

        public override void EnterState()
        {
            FlagBitMgr.Instance.FindBy(this.integralStateMachine.ConveyorNo).State.IntegralState = IntegralStateEnum.运行PassThrough;
