...
namespace csDmc1000
{
    public class Dmc1000
    {
        ...
        public static extern int d1000_start_t_line(int TotalAxis, int[] AxisArray,int[] DistArray, int StrVel, int MaxVel, double Tacc);
        [DllImport("Dmc1000.dll", EntryPoint = "d1000_start_ta_line", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern int d1000_start_ta_line(int TotalAxis,int[] AxisArray, int[] DistArray, int StrVel, int MaxVel, double Tacc);
