...
namespace ViewROI
{
	...
	public class HWndCtrl
	{
        ...
        /// <summary>Zoom & Move is performed on mouse events</summary>
        public const int MODE_VIEW_ZOOM_MOVE = 14;
        ...
        public bool Flag_ROI_Fixed = false;
		...
		/// </summary>
		public ArrayList HObjList { get; private set; }

        public HImage Image { get; private set; }

        public List<HRegion> HRegionList { get; private set; }
		...
		public HWndCtrl(HWindowControl view)
		{
			...
			// graphical stack 
			HObjList = new ArrayList(MAXNUMOBJLIST);
            HRegionList = new List<HRegion>(MAXNUMOBJLIST);
        ...
        public void setROIEnabled(bool b)
        {
            Flag_ROI_Fixed = b;
		...
		private void mouseMoved(object sender, HalconDotNet.HMouseEventArgs e)
		{
			...
			else if (stateView == MODE_VIEW_MOVE || stateView == MODE_VIEW_ZOOM_MOVE)
			{
				motionX = ((e.X - startX));
				motionY = ((e.Y - startY));
        ...
        public void addRegion(HRegion region)
        {
            ...
            HRegionList.Add(region);
            if(HRegionList.Count > MAXNUMOBJLIST)
            {
                HRegionList.RemoveAt(1);
            }
        }
