...
{
    public partial class EditCircleForm1 : EditFormBase, IMsgSender
    {
        ...
        /// 仅用于生成语言文本
        /// </summary>
        private EditCircleForm1()
        {
            InitializeComponent();
        }
        public EditCircleForm1(Pattern pattern) : this(pattern, null)
        {
        }

        public EditCircleForm1(Pattern pattern, CircleCmdLine circleCmdLine) : base(pattern.GetOriginPos())
        {
            InitializeComponent();
        ...
        private void btnNextCmdLine_Click(object sender, EventArgs e)
        {
            ...
            SwitchSymbolForm.Instance.SwitchNextSymbol(this.circleCmdLine,this);
        }

        private void btnLastCmdLine_Click(object sender, EventArgs e)
        {
            this.btnOk_Click(sender, e);
            SwitchSymbolForm.Instance.SwitchLastSymbol(this.circleCmdLine,this);
        }
    }
}
