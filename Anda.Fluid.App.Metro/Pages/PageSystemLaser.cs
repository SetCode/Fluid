...
{
    public partial class PageSystemLaser : MetroSetUserControl, IAccessControllable
    {
        //权限执行
        private AccessExecutor accessExecutor;
        public PageSystemLaser()
        {
            InitializeComponent();
        ...
        #region 权限
        public int Key { get; set; } = (int)ContainerKeys.PageSystemLaser;
        ...
        public void SetDefaultAccess()
        {
            ...
            this.DefaultContainerAccess.ContainerAccessDescription = "测高诊断";
