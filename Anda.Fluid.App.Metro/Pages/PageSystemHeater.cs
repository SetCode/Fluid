...
{
    public partial class PageSystemHeater : MetroSetUserControl, IAccessControllable
    {
        //权限执行
        ...
        #region 权限
        public int Key { get; set; } = (int)ContainerKeys.PageSystemHeater;
        ...
        public void SetDefaultAccess()
        {
            ...
            this.DefaultContainerAccess.ContainerAccessDescription = "加热状态";
