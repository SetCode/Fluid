...
{
    public partial class EditSnakeLineForm1 : EditFormBase, IMsgSender
    {
        ...
        /// 仅用于生成语言文本
        /// </summary>
        public EditSnakeLineForm1()
        {
            InitializeComponent();
        }
        public EditSnakeLineForm1(Pattern pattern) : this(pattern, null)
        {
        }

        public EditSnakeLineForm1(Pattern pattern, SnakeLineCmdLine snakeLineCmdLine) : base(pattern.GetOriginPos())
        {
            InitializeComponent();
        ...
        private void btnNextCmdLine_Click(object sender, EventArgs e)
        {
            ...
            SwitchSymbolForm.Instance.SwitchNextSymbol(this.snakeLineCmdLine, this);
        }

        private void btnLastCmdLine_Click(object sender, EventArgs e)
        {
            this.btnOk_Click(sender, e);
            SwitchSymbolForm.Instance.SwitchLastSymbol(this.snakeLineCmdLine, this);
        }
