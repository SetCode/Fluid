...
{
    public partial class PageSetupSensors : MetroSetUserControl, IMsgSender,IAccessControllable
    {
        ...
        #region 权限
        public int Key { get; set; } = (int)ContainerKeys.PageSetupSensors;
        ...
        public void SetDefaultAccess()
        {
            ...
            this.DefaultContainerAccess.ContainerAccessDescription = "传感器设置";
