...
namespace Anda.Fluid.Drive.Motion.Command
{
    ...
    public class CommandMoveTrc3Axis : CommandMotion, ICloneable
    {
        ...
        public CommandMoveTrc3Axis(Axis axisX, Axis axisY, Axis axisR, MoveTrcPrm4Axis trcPrm, IList<ICrdable> crds, int cardType)
        ...
        public CommandMoveTrc3Axis(Axis axisX, Axis axisY, Axis axisR, MoveTrcPrm4Axis trcPrm, ICrdable crd, int cardType)
