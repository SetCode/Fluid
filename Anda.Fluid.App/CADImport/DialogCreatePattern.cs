...
namespace Anda.Fluid.App.CADImport
{
    ...
    {        
        ...
        private void btnGtoOrg_Click(object sender, EventArgs e)
        {
            Machine.Instance.Robot.ManualMovePosXYAndReply(this.patternNewOrg.X, this.patternNewOrg.Y);
        }
        private void updateOrgSetting()
        {
            StringBuilder sb = new StringBuilder();
            if (this.markComp1!=null)
            {
                sb.Clear();
                sb.Append(this.markComp1.Desig).Append("[").Append(this.markComp1.Mid.X.ToString("0.000")).Append(",").Append(this.markComp1.Mid.Y.ToString("0.000")).Append("]");
                this.txtComponent1.Text = sb.ToString();
            }
            if (this.markComp2 != null)
            {
                sb.Clear();
                sb.Append(this.markComp2.Desig).Append("[").Append(this.markComp2.Mid.X.ToString("0.000")).Append(",").Append(this.markComp2.Mid.Y.ToString("0.000")).Append("]");
                this.txtComponent2.Text = sb.ToString();
            }
            if (this.mark1!=null)
            {
                this.txtMark1X.Text = this.mark1.X.ToString("0.000");
                this.txtMark1Y.Text = this.mark1.Y.ToString("0.000");
            }
            if (this.mark2 != null)
            {
                this.txtMark2X.Text = this.mark2.X.ToString("0.000");
                this.txtMark2Y.Text = this.mark2.Y.ToString("0.000");
            }          
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (this.markComp1!=null && this.markComp2 != null && this.mark1 != null && this.mark2 != null)
                {
                    CreatePatternPrm.DEFAULT.PatternPath = this.currPath;
                    CreatePatternPrm.DEFAULT.Comp1 = this.markComp1;
                    CreatePatternPrm.DEFAULT.Comp2 = this.markComp2;
                    CreatePatternPrm.DEFAULT.Comp1Pos = this.mark1;
                    CreatePatternPrm.DEFAULT.Comp2Pos = this.mark2;
                }
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            {
                this.patternNewOrg = FluidProgram.Current.Workpiece.GetOriginPos();
            }
            if (FluidProgram.Current == null)
            {
            ...
            else if (FluidProgram.Current != null)
            {
                ...
                {                  
                    ...
                    else 
                    {
                        ...
                        dotCmdLine.OrgOffset = new PointD(p.OrgOffset.X, p.OrgOffset.Y);
                        if (!p.IsWeight)
                        {
        ...
        private void ckbOrg_CheckedChanged(object sender, EventArgs e)
        {
