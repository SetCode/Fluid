...
using Anda.Fluid.Domain.Dialogs.CmdLineFineTune.Forms;
...
{
    public partial class ProgramControl : UserControlEx, IMsgReceiver, IMsgSender, IControlUpdating,IMultiDrawCmdEditable
    {
        ...
        private void InitMenu()
        {
            ...
            this.tsbMovePrev.Text = "Move Up";
            this.tsbMoveNext.Text = "Move Down";
            ...
            this.tsbMotionSetting.Text = "Motion Setting";
            ...
            this.tsbBarcode.Text = "Barcode";
            this.tsbConveyorBarcode.Text = "Conveyor Barcode";
            this.tsbMultiTraces.Text = "Multi Traces";
            this.tsbModifyComp.Text = "修改元器件";
            ...
            this.tscCycle.Items.Add(1);
            this.tscCycle.Items.Add(5);
            this.tscCycle.Items.Add(10);
            this.tscCycle.Items.Add(20);
            this.tscCycle.Items.Add(30);
            this.tscCycle.Items.Add(50);
            this.tscCycle.Items.Add(100);
            this.tscCycle.SelectedIndexChanged += TscCycle_SelectedIndexChanged;
            this.tscCycle.SelectedIndex = 0;
        ...
        private void TscCycle_SelectedIndexChanged(object sender, EventArgs e)
        {
            //if (this.program == null) return;
            //int offlineCycle = 1;
            //try
            //{
            //    offlineCycle = int.Parse(tscCycle.Text);
            //}
            //catch
            //{
            //    this.tscCycle.SelectedIndex = 0;
            ...
            //    this.tscCycle.SelectedIndex = 0;
            //}
            //this.program.RuntimeSettings.OfflineCycle = offlineCycle;
        }
        ...
        public override void SaveLanguageResources(bool skipButton = false, bool skipRadioButton = false, bool skipCheckBox = false, bool skipLabel = false)
        {
            ...
            this.SaveKeyValueToResources(this.tsbMovePrev.Name, this.tsbMovePrev.Text);
            this.SaveKeyValueToResources(this.tsbMoveNext.Name, this.tsbMoveNext.Text);
            ...
            this.SaveKeyValueToResources(this.tsbMotionSetting.Name, this.tsbMotionSetting.Text);
            ...
            this.SaveKeyValueToResources(this.tsbBarcode.Name, this.tsbBarcode.Text);
            this.SaveKeyValueToResources(this.tsbConveyorBarcode.Name, this.tsbConveyorBarcode.Text);
            this.SaveKeyValueToResources(this.tsbMeasurement.Name, this.tsbMeasurement.Text);
            this.SaveKeyValueToResources(this.tsbComplexLine.Name, this.tsbComplexLine.Text);
            this.SaveKeyValueToResources(this.tsbModifyComp.Name, this.tsbModifyComp.Text);
        ...
        public override void ReadLanguageResources(bool skipButton = false, bool skipRadioButton = false, bool skipCheckBox = false, bool skipLabel = false)
        {
            if (this.HasLngResources())
            {
                ...
                this.tsbMovePrev.Text = this.ReadKeyValueFromResources(this.tsbMovePrev.Name);
                this.tsbMoveNext.Text = this.ReadKeyValueFromResources(this.tsbMoveNext.Name);
                ...
                //汉化新增
                this.tsbPurg.Text = this.ReadKeyValueFromResources(this.tsbPurg.Name);
                this.tsbChangeSvSpeed.Text = this.ReadKeyValueFromResources(this.tsbChangeSvSpeed.Name);
                this.tsbMotionSetting.Text = this.ReadKeyValueFromResources(this.tsbMotionSetting.Name);
                this.tsbComplexLine.Text = this.ReadKeyValueFromResources(this.tsbComplexLine.Name);
                this.tsbBarcode.Text = this.ReadKeyValueFromResources(this.tsbBarcode.Name);
                this.tsbConveyorBarcode.Text = this.ReadKeyValueFromResources(this.tsbConveyorBarcode.Name);
                this.tsbMeasurement.Text = this.ReadKeyValueFromResources(this.tsbMeasurement.Name);
                this.tsbMovePrev.Text = this.ReadKeyValueFromResources(this.tsbMovePrev.Name);
                this.tsbMoveNext.Text = this.ReadKeyValueFromResources(this.tsbMoveNext.Name);
                this.tsbConveyorWidth.Text = this.ReadKeyValueFromResources(this.tsbConveyorWidth.Name);
                this.cbxSimulation.Text = this.ReadKeyValueFromResources(this.cbxSimulation.Name);
                this.tsbAdd.Text = this.ReadKeyValueFromResources(this.tsbAdd.Name);
                this.tsbCorrectMark.Text = this.ReadKeyValueFromResources(this.tsbCorrectMark.Name);
                this.tsbMultiTraces.Text = this.ReadKeyValueFromResources(this.tsbMultiTraces.Name);
                this.moveXYToolStripMenuItem.Text = this.ReadKeyValueFromResources(this.moveXYToolStripMenuItem.Name);
                this.moveAbsXYToolStripMenuItem.Text = this.ReadKeyValueFromResources(this.moveAbsXYToolStripMenuItem.Name);
                this.moveAbsZToolStripMenuItem.Text = this.ReadKeyValueFromResources(this.moveAbsZToolStripMenuItem.Name);
                this.moveToLocToolStripMenuItem.Text = this.ReadKeyValueFromResources(this.moveToLocToolStripMenuItem.Name);
                this.toolStripStatusLabel1.Text = this.ReadKeyValueFromResources(this.toolStripStatusLabel1.Name);
                this.toolStripStatusLabel2.Text = this.ReadKeyValueFromResources(this.toolStripStatusLabel2.Name);
                this.toolStripStatusLabel3.Text = this.ReadKeyValueFromResources(this.toolStripStatusLabel3.Name);
                this.toolStripStatusLabel4.Text = this.ReadKeyValueFromResources(this.toolStripStatusLabel4.Name);
                this.toolStripStatusLabel5.Text = this.ReadKeyValueFromResources(this.toolStripStatusLabel5.Name);
                this.toolStripStatusLabel6.Text = this.ReadKeyValueFromResources(this.toolStripStatusLabel6.Name);
                this.toolStripStatusLabel7.Text = this.ReadKeyValueFromResources(this.toolStripStatusLabel7.Name);
                this.tsbModifyComp.Text = this.ReadKeyValueFromResources(this.tsbModifyComp.Name);
                //  
        ...
        private void InitExecutor()
        {
                    ...
                    this.Invoke(new MethodInvoker(() =>
                    {
                        ...
                        switch (newState)
                        {
                            case Executor.ProgramOuterState.IDLE:
                                ...
                                tsbPause.Enabled = false;
                                tsbAbort.Enabled = false;
                                tsbPause.Image = Properties.Resources.Pause_30px;
                            ...
                            case Executor.ProgramOuterState.PAUSED:
                                ...
                                tsbPause.Enabled = true;
                                tsbAbort.Enabled = true;
                                tsbPause.Image = Properties.Resources.Resume_Button_30px;
            ...
            Executor.Instance.OnOfflineCycleChanged += i =>
            {                
                this.BeginInvoke(new MethodInvoker(() =>
                {
                    this.tslOfflineCycle.Text = i.ToString();
                }));
            };
        }
        ...
        private void EnableEditMenu(bool b)
        {
            ...
            this.BeginInvoke(new MethodInvoker(() =>
            {
                if (b == true)
                {
                    ...
                    tsbOpen.Enabled = role.ProgramFormAccess.CanUseProgramFileOperate;
                    tsbSave.Enabled = role.ProgramFormAccess.CanUseProgramFileOperate;
                    ...
                    tsbMovePrev.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    tsbMoveNext.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    ...
                    tsbMotionSetting.Enabled = role.ProgramFormAccess.CanEnterProgramSettingForm;
                    ...
                    tsbInspection.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    tsbCorrectMark.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    tsbFineTune.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    tstFindTrack.Enabled = role.MainFormAccess.CanUseCbxRunMode;
                    tsbFluidMode.Enabled = role.MainFormAccess.CanUseCbxRunMode;
                    tscCycle.Enabled = role.MainFormAccess.CanUseCbxRunMode;
                    tsbConveyorSelected.Enabled = role.MainFormAccess.CanUseCbxRunMode;
                    tsbConveyorWidth.Enabled = role.MainFormAccess.CanUseCbxRunMode;
                    //做菜单
                    toolStripLeft1.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    toolStripLeft2.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbDisable.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbComments.Enabled = role.ProgramFormAccess.CanUseOtherCmd;
                    //tsbBarcode.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbConveyorBarcode.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    ...
                    //tsbPurg.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbChangeSvSpeed.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbMark.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbASVMark.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbBadMark.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    ...
                    //tsbMultiTraces.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                    //tsbComplexLine.Enabled = role.ProgramFormAccess.CanUseGluePathCmd;
                ...
                else
                {
                    ...
                    tsbMovePrev.Enabled = false;
                    tsbMoveNext.Enabled = false;
                    tsbBatchUpdate.Enabled = false;
                    tsbSetting.Enabled = false;
                    tsbMotionSetting.Enabled = false;
                    tsbSystemLoc.Enabled = false;
                    tsbDoScale.Enabled = false;
                    tsbDoPurge.Enabled = false;
                    tsbInspection.Enabled = false;
                    tsbCorrectMark.Enabled = false;
                    tsbFineTune.Enabled = false;
                    tstFindTrack.Enabled = false;
                    tsbFluidMode.Enabled = false;
                    tscCycle.Enabled = false;
                    tsbConveyorSelected.Enabled = false;
                    tsbConveyorWidth.Enabled = false;
                    //左菜单
                    toolStripLeft1.Enabled = false;
                    toolStripLeft2.Enabled = false;
                }
                ...
                {
                    tsbDot.Enabled = false;
                    tsbSingleLine.Enabled = false;
                    tsbPolyLine.Enabled = false;
                    tsbLine.Enabled = false;
                    tsbCircle.Enabled = false;
                    tsbArc.Enabled = false;
                    tsbSnake.Enabled = false;
                    tsbMultiTraces.Enabled = false;
                    tsbFinishShot.Enabled = false;
                }
                else
                {
                    //tsbComplexLine.Enabled = false;
                }
            }));
        }
        ...
        public void HandleMsg(string msgName, IMsgSender sender, params object[] args)
        {
            ...
            else  if (msgName == Constants.MSG_PATTERN_EDITED)
            {
            ...
            else if (msgName == Domain.MsgType.MSG_SINGLE_DOT_SETTING)
            {
                this.tsbSetting_Click(null, null);
            }
        }
        ...
        private void ScriptEditor1_OnEditCmdLineEvent(CommandsModule commandsModule, CmdLine cmdLine)
        {
            ...
            {
                new EditSymbolLinesForm(commandsModule as Pattern, cmdLine as SymbolLinesCmdLine).ShowDialog();
            }
            else if (cmdLine is MultiTracesCmdLine)
            {
                new EditMultiTracesForm(commandsModule as Pattern, cmdLine as MultiTracesCmdLine).ShowDialog();
            }
            ...
            else if (cmdLine is MarkCmdLine)
            {
                ...
                else
                {
                    if (new EditModelFindForm(markCmdLine.ModelFindPrm, pattern).ShowDialog() == DialogResult.OK)
                    {
                        ...
                        //mark实际位置来自文件
                        markCmdLine.IsFromFile = markCmdLine.ModelFindPrm.IsFromFile;
            ...
            else if (cmdLine is BlobsCmdLine)
            {
                Pattern pattern = commandsModule as Pattern;
                PointD originSys = pattern.GetOriginSys();
                BlobsCmdLine blobsCmdLine = cmdLine as BlobsCmdLine;
                Machine.Instance.Robot.MoveSafeZ();
                Machine.Instance.Robot.ManualMovePosXY((blobsCmdLine.PosInPattern + originSys).ToMachine());
                if (new EditBlobsForm(blobsCmdLine.BlobsTool).ShowDialog() == DialogResult.OK)
                {
                    blobsCmdLine.PosInPattern = (Machine.Instance.Robot.PosXY - pattern.GetOriginPos()).ToPoint().ToSystem();
                    MsgCenter.Broadcast(Constants.MSG_FINISH_EDITING_CMD_LINE, this, blobsCmdLine);
                }
            }
            ...
            {
                new EditMoveXyForm(commandsModule as Pattern, cmdLine as MoveXyCmdLine).ShowDialog();
            }
            ...
            {
                new EditMeasurementForm(commandsModule as Pattern, cmdLine as MeasureCmdLine).ShowDialog();
            }
            else if (cmdLine is BarcodeCmdLine)
            {
                new EditBarcodeForm(commandsModule as Pattern, cmdLine as BarcodeCmdLine).ShowDialog();
            }
            ...
            {
                new EditChangeSvSpeedForm(cmdLine as ChangeSpeedCmdLine).ShowDialog();
            }
        }
        ...
        {
            if (this.tsbConveyorSelected.SelectedIndex == 1 && FluidProgram.CurrentOrDefault().Conveyor2OriginOffset != null) 
            {
                FluidProgram.CurrentOrDefault().ExecutantOriginOffset = FluidProgram.CurrentOrDefault().Conveyor2OriginOffset;
            }
            else
            {
                FluidProgram.CurrentOrDefault().ExecutantOriginOffset = new PointD(0, 0);
            }
            this.getOfflineCycle(); 
        ...
        private void tsbMeasurement_Click(object sender, EventArgs e)
        {
            if (scriptEditor1.CurrCommandsModule!=null && scriptEditor1.CurrCommandsModule is Pattern)
            {
                new EditMeasurementForm(scriptEditor1.CurrCommandsModule as Pattern).ShowDialog();
            }
        }
        ...
        private void moveXYToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (scriptEditor1.CurrCommandsModule != null && scriptEditor1.CurrCommandsModule is Pattern)
            {
                new EditMoveXyForm(scriptEditor1.CurrCommandsModule as Pattern).ShowDialog();
            }
            //if (scriptEditor1.CurrCommandsModule != null && scriptEditor1.CurrCommandsModule is Pattern)
            //{
            //    new EditDotForm1(scriptEditor1.CurrCommandsModule as Pattern).ShowDialog();
        ...
        private async void tsbDoScale_Click(object sender, EventArgs e)
        {
            ...
            await Task.Factory.StartNew(() =>
            {
                ...
                if (Machine.Instance.Scale.Scalable.CommunicationOK==Drive.Sensors.ComCommunicationSts.ERROR)
                {
                    scaleSts = false;
                }
                else
        ...
        private void tsbSetting_Click(object sender, EventArgs e)
        {
            ...
            bool markSort = this.program.RuntimeSettings.MarksSort;
            new ProgramSettingForm(this.program).ShowDialog();
            if (!markSort && this.program.RuntimeSettings.MarksSort)
            {
                checkGrammar();
            }
        }
        ...
        private void tsbBoardIn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Logger.DEFAULT.Info(LogCategory.RUNNING, TAG, "Conveyor2 bord in");
            }
        }
        ...
        private void tsbComplexLine_Click(object sender, EventArgs e)
        {
            if (scriptEditor1.CurrCommandsModule != null && scriptEditor1.CurrCommandsModule is Pattern)
            {
                Pattern pattern = scriptEditor1.CurrCommandsModule as Pattern;
                EditSymbolLinesForm symbolLineForm = new EditSymbolLinesForm(pattern);
                symbolLineForm.ShowDialog();
            }
        }
        ...
        private void tsbBarcode_Click(object sender, EventArgs e)
        {
            ...
            {
                Pattern pattern = scriptEditor1.CurrCommandsModule as Pattern;
                new EditBarcodeForm(pattern).ShowDialog();
            }
        }

        private void tsbConveyorBarcode_Click(object sender, EventArgs e)
        {
            if (scriptEditor1.CurrCommandsModule != null && scriptEditor1.CurrCommandsModule is Pattern)
            {
                ConveyorBarcodeCmdLine cmdLine = new ConveyorBarcodeCmdLine();
                MsgCenter.Broadcast(Constants.MSG_FINISH_ADDING_CMD_LINE, this, cmdLine);
            }
        }

        private void tsbMultiTraces_Click(object sender, EventArgs e)
        {
            if (scriptEditor1.CurrCommandsModule != null && scriptEditor1.CurrCommandsModule is Pattern)
            {
                new EditMultiTracesForm(scriptEditor1.CurrCommandsModule as Pattern).ShowDialog();
            }
        }

        private void tsbMotionSetting_Click(object sender, EventArgs e)
        {
            if (this.program == null)
            {
                return;
        ...
        private void tsbFineTune_Click(object sender, EventArgs e)
        {
            if (scriptEditor1.CurrCommandsModule == null)
            {
                return;
            }
            new CmdLineFineTuneForm(scriptEditor1.CurrCommandsModule as Pattern).ShowDialog();
            this.scriptEditor1.UpdateCmdLines();
            checkGrammar();
            FluidProgram.Current.HasChanged = true;
        }

        private void tsbLoadTraj_Click(object sender, EventArgs e)
        {
            if (this.program == null)
            {
                return;
            }
            new DialogCreatePattern().ShowDialog();

        }


        private void tsbModifyComp_Click(object sender, EventArgs e)
        {
            if (scriptEditor1.CurrCommandsModule != null && scriptEditor1.CurrCommandsModule is Pattern)
            {
                new ModifyCompForm(scriptEditor1.CurrCommandsModule).Show();            
            }
        }
            ...
            if (msg.Msg == WM_KEYDOWN)
            {
                switch (keyData)
                {
                    case Keys.C | Keys.Control:
                        //this.Copy();
                        this.tsbCopy_Click(null, null);
                        break;
                    case Keys.V | Keys.Control:
                        //this.Paste();
                        this.tsbPaste_Click(null, null);
                        break;                   
                    default:
        ...
        private void btnBlobs_Click(object sender, EventArgs e)
        {
            ...
            {
                Pattern pattern = scriptEditor1.CurrCommandsModule as Pattern;
                EditBlobsForm editBlobsForm = new EditBlobsForm();
                if (editBlobsForm.ShowDialog() == DialogResult.OK)
                {
                    BlobsCmdLine blobsCmdLine = new BlobsCmdLine() { BlobsTool = editBlobsForm.GetBlobs() };
                    blobsCmdLine.PosInPattern = (Machine.Instance.Robot.PosXY - pattern.GetOriginPos()).ToPoint().ToSystem();
                    MsgCenter.Broadcast(Constants.MSG_FINISH_ADDING_CMD_LINE, this, blobsCmdLine);
                }
            }
        }
    }
