...
{
    public partial class EditPassBlockMetro : MetroSetUserControl, IMsgSender
    {
        ...
        /// 仅用于生成语言文本
        /// </summary>
        private EditPassBlockMetro()
        {
            InitializeComponent();
        }
        public EditPassBlockMetro(PassBlockCmdLine passBlockCmdLine)
        {
            InitializeComponent();
