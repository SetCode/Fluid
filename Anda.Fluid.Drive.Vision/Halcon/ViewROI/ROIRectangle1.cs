...
namespace ViewROI
{
	...
	public class ROIRectangle1 : ROI
	{
        ...
        public override void draw(HalconDotNet.HWindow window)
		{
			...
			window.DispRectangle2(row1, col1, 0, 10, 10);
			window.DispRectangle2(row1, col2, 0, 10, 10);
			window.DispRectangle2(row2, col2, 0, 10, 10);
			window.DispRectangle2(row2, col1, 0, 10, 10);
			window.DispRectangle2(midR, midC, 0, 10, 10);
		}
