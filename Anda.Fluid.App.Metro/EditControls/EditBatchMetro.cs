...
{
    public partial class EditBatchMetro : MetroSetUserControl, IMsgSender,ICanSelectButton
    {
        ...
        private EditBatchMetro()
        {
            InitializeComponent();
        }

        public EditBatchMetro(Pattern pattern, List<CmdLine> cmdLines)
        {
            InitializeComponent();
        ...
        public void SetSelectButtons()
        {
            ...
            buttons.Add(this.btnTeachRef);
            buttons.Add(this.btnTeachTarget);
