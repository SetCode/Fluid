...
namespace Anda.Fluid.App.Main.EventBroker
{
    class RunBroker
    {
        ...
        private void Instance_OnProgramRunning()
        {
        ...
        {
            //通知轨道：点胶完成
            if (Executor.Instance.Program.ExecutantOriginOffset.Equals(new PointD(0, 0)))
            {
        ...
        private void Instance_OnWorkDone()
        {

        }

        private void Instance_OnWorkStop()
        {


        }

        private void Instance_OnProgramPaused()
        {

        }

        private void Instance_OnProgramResuming()
        {
