...
namespace Anda.Fluid.Drive.SetupCard
{
    ...
    /// 8轴Gts卡，双阀
    /// </summary>
    internal class CardSetupGts8x1 : ICardSetupable
    {
        public RobotXYZ Setup()
        {
            ...
            Axis axisA = new Axis((int)AxisType.A轴, card, 5, AxisType.A轴.ToString(), AxisPrmMgr.Instance.FindBy(5));
            Axis axisB = new Axis((int)AxisType.B轴, card, 6, AxisType.B轴.ToString(), AxisPrmMgr.Instance.FindBy(6));
