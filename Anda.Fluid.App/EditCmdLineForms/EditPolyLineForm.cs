...
{
    public partial class EditPolyLineForm : EditFormBase, IMsgSender
    {
        ...
        /// 仅用于生成语言文本
        /// </summary>
        private EditPolyLineForm()
        {
            InitializeComponent();
        }
        public EditPolyLineForm(Pattern pattern) : this(pattern, null)
        {
        }
        ...
        private void EditPolyLineForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose(true);
        }

        public EditPolyLineForm(Pattern pattern, LineCmdLine lineCmdLine, Line line, int indexOfLineCoordinate) : this(pattern, lineCmdLine)
        {
            this.line = line;
            this.isRunning = true;
