...
{
    [Serializable]
    public class StartPassCmdLine : CmdLine
    {
        [CompareAtt("CMP")]
        private int index;
        public int Index
        ...
        public StartPassCmdLine() : this(0)
        {
        }

        public StartPassCmdLine(int index) : base(true)
        {
            this.index = index;
        }
        ...
        public override string ToString()
        {
            ...
            return sb.Append("START PASS : FOR PASS ").Append(index).ToString();
        }
