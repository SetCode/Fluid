...
{
    public partial class PageSystemCPK : MetroSetUserControl, IAccessControllable
    {
        //权限执行
        ...
        #region 权限
        public int Key { get; set; } = (int)ContainerKeys.PageSystemCPK;
        ...
        public void SetDefaultAccess()
        {
            ...
            this.DefaultContainerAccess.ContainerAccessDescription = "CPK";
