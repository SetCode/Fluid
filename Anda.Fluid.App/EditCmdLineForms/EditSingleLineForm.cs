...
{
    public partial class EditSingleLineForm : EditFormBase, IMsgSender
    {
        ...
        /// 仅用于生成语言文本
        /// </summary>
        private EditSingleLineForm()
        {
            InitializeComponent();
        }
       
        public EditSingleLineForm(Pattern pattern) : this(pattern, null)
        {
        }

        public EditSingleLineForm(Pattern pattern, LineCmdLine lineCmdLine) : base(pattern.GetOriginPos())
        {
            InitializeComponent();
            this.ReadLanguageResources();
            this.robotIsXYZU = Machine.Instance.Robot.RobotIsXYZU;
            this.robotIsXYZUV = Machine.Instance.Robot.RobotIsXYZUV;
            ...
            if (showTiltProperty)
            {
                ...
                this.cbTiltType.SelectedIndex = (int)this.lineCmdLine.Tilt;
            }
            ...
            this.FormClosed += EditSingleLineForm_FormClosed;
        }

        private void EditSingleLineForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose(true);
        }
        ...
        private void btnOk_Click(object sender, System.EventArgs e)
        {
            ...
            lineCmdLine.Tilt = (TiltType)cbTiltType.SelectedIndex;
