...
{
    public partial class EditArcMetro : MetroSetUserControl, IMsgSender,ICanSelectButton
    {
        ...
        /// 仅用于生成语言文本
        /// </summary>
        private EditArcMetro()
        {
            InitializeComponent();
        }

        public EditArcMetro(Pattern pattern) : this(pattern, null)
        {
        }

        public EditArcMetro(Pattern pattern, ArcCmdLine arcCmdLine)
        {
            InitializeComponent();
        ...
        private void btnOk_Click(object sender, System.EventArgs e)
        {
                ...
                || (tbCenterX.Value == tbEndX.Value && tbCenterY.Value == tbEndY.Value))
            {
                ...
                MetroSetMessageBox.Show(this, "中间点和SME点不可以相同");
                return;
            }
