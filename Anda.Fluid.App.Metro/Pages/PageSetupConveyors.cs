...
{
    public partial class PageSetupConveyors : MetroSetUserControl,IAccessControllable
    {
        //权限执行
        ...
        #region 权限
        public int Key { get; set; } = (int)ContainerKeys.PageSetupConveyors;
        ...
        public void SetDefaultAccess()
        {
            ...
            this.DefaultContainerAccess.ContainerAccessDescription = "轨道设置";
