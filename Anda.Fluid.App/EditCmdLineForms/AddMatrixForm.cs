...
{
    public partial class AddMatrixForm : EditFormBase, IMsgSender
    {
        ...
        /// 仅用于生成语言文本
        /// </summary>
        private AddMatrixForm()
        {
            InitializeComponent();
        }
        public AddMatrixForm(Pattern pattern) : base(pattern.GetOriginPos())
        {
            InitializeComponent();
        ...
        private void ListBoxOrigins_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                this.cmsValveType.Show(new Point(this.Location.X + this.gbx1.Location.X + this.listBoxOrigins.Location.X + e.Location.X,
                    this.Location.Y + this.gbx1.Location.Y + this.listBoxOrigins.Location.Y + e.Location.Y + this.cmsValveType.Size.Height / 2));
            }
        }
        ...
        private void AddMatrixForm_Load(object sender, EventArgs e)
        {
